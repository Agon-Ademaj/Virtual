...
<head>
  <title>AgoX | Te punsutarit</title>
...
<body>
  ...
  <table class="showproducts">
    <tr>
      <th>Emri punetorit</th>
      <th>Roli i punetorit</th>
    ...
    <tr>
      ...
      $showemp = $emp->showEmployee();

      foreach ($showemp as $employees) :
      ?>
        <td><?php echo $employees['employename'] ?></td>
        <td><?php echo $employees['employerole'] ?></td>
        <td><?php echo $employees['employedesc'] ?></td>
        <!-- <td><i class="fa-solid fa-pen-to-square" style="color: #333; cursor: pointer;"></i></td> -->
        <td><a style="cursor: pointer;" href="deleteEmployee.php?id= <?php echo $employees['employeid']; ?>"><i class="fa-solid fa-trash-can" style="color: #333;"></i></a></td>
    </tr>
  <?php endforeach; ?>
  </table>
